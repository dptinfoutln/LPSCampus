CREATE TABLE UTILISATEUR (ID BIGINT NOT NULL, CARACTERISTIQUESMACHINE VARCHAR(255), LASTSCAN_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE SUPERVISEUR (ID BIGINT NOT NULL, CARACTERISTIQUESMACHINE VARCHAR(255), EMAIL VARCHAR(255), PASSWORDHASH VARCHAR(255), RANDOM LONGBLOB, SALT LONGBLOB, LASTSCAN_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE ADMINISTRATEUR (ID BIGINT NOT NULL, CARACTERISTIQUESMACHINE VARCHAR(255), EMAIL VARCHAR(255), PASSWORDHASH VARCHAR(255), RANDOM LONGBLOB, SALT LONGBLOB, CAMPUS_ID BIGINT, LASTSCAN_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE BATIMENT (ID BIGINT NOT NULL, NAME VARCHAR(255), POSITION_X INTEGER, POSITION_Y INTEGER, PRIMARY KEY (ID))
CREATE TABLE CAMPUS (ID BIGINT NOT NULL, NAME VARCHAR(255), PLAN VARCHAR(255), PRIMARY KEY (ID))
...
ALTER TABLE SUPERVISEUR ADD CONSTRAINT FK_SUPERVISEUR_LASTSCAN_ID FOREIGN KEY (LASTSCAN_ID) REFERENCES SCANDATA (ID)
ALTER TABLE ADMINISTRATEUR ADD CONSTRAINT FK_ADMINISTRATEUR_CAMPUS_ID FOREIGN KEY (CAMPUS_ID) REFERENCES CAMPUS (ID)
ALTER TABLE ADMINISTRATEUR ADD CONSTRAINT FK_ADMINISTRATEUR_LASTSCAN_ID FOREIGN KEY (LASTSCAN_ID) REFERENCES SCANDATA (ID)
