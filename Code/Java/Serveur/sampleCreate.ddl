CREATE TABLE UTILISATEUR (ID BIGINT NOT NULL, DTYPE VARCHAR(31), CARACTERISTIQUESMACHINE VARCHAR(255), LASTSCAN_ID BIGINT, EMAIL VARCHAR(255), PASSWORDHASH VARCHAR(255), RANDOM LONGBLOB, SALT LONGBLOB, CAMPUS_ID BIGINT, PRIMARY KEY (ID))
