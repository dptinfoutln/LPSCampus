CREATE TABLE UTILISATEUR (ID BIGINT NOT NULL, DTYPE VARCHAR(31), CARACTERISTIQUESMACHINE VARCHAR(255), LASTSCAN_ID BIGINT, EMAIL VARCHAR(255), PASSWORDHASH LONGBLOB, RANDOM LONGBLOB, SALT LONGBLOB, PRIMARY KEY (ID))
...
CREATE TABLE BUGREPORT (ID BIGINT NOT NULL, CARACTERISTIQUESMACHINE VARCHAR(255), CATEGORY VARCHAR(255), CONTENT VARCHAR(255), DATE DATE, PRIMARY KEY (ID))
...
CREATE TABLE SCANDATA (ID BIGINT AUTO_INCREMENT NOT NULL, DATESCAN DATE, INFOSCAN VARCHAR(255), PIECE_ID BIGINT, SUPERVISEUR_ID BIGINT, PRIMARY KEY (ID))
