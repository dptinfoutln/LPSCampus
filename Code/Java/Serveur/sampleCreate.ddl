CREATE TABLE UTILISATEUR (ID BIGINT NOT NULL, DTYPE VARCHAR(31), CARACTERISTIQUESMACHINE VARCHAR(255), LASTSCAN_ID BIGINT, EMAIL VARCHAR(255), PASSWORDHASH LONGBLOB, RANDOM LONGBLOB, SALT LONGBLOB, CAMPUS_ID BIGINT, PRIMARY KEY (ID))
